export interface Advisor {
  ...
  tags: string[];
  photo?: string;
  /** CSS object-position override for the avatar, e.g. "50% 25%". Default: "top". */
  photoFocus?: string;
  /** Zoom-in factor inside the avatar circle, e.g. 1.4 for a tighter face crop. Default: 1. */
  photoZoom?: number;
}
...
export const advisors: Advisor[] = [
  ...
  },
  {
    ...
    bio: [
      ...
      'Over twenty years in Tokyo, at The Austin Company, PAE International, and AeA, building partnerships between Japanese and non-Japanese entities in high-tech and financial services.',
  ...
  },
  {
    ...
    photo: '/people/prakash-mathur.jpg',
  },
  {
    id: 'vijay-batra',
    ...
    bio: [
      ...
      'At Reiwa, Vijay advises on the human dimension of Indo-Japanese engagements: how senior Indian and Japanese executives learn to work productively together.',
    ],
    tags: ['Executive coaching', 'Indo-Japanese cultural fluency', 'Senior facilitation'],
    photo: '/people/vijay-batra.jpg',
  },
  {
    id: 'puneet-nayyar',
    name: 'Puneet Nayyar',
    ...
    photo: '/people/puneet-nayyar.jpg',
    photoFocus: '50% 35%',
    photoZoom: 1.5,
  },
  {
    ...
    bio: [
      'Built and led communication functions across Fidelity International, NEC Corporation, American Express, HSBC, and Genpact, across the UK, USA, APAC, Japan, and India.',
